...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-KBPUG7Tv.js
var server_KBPUG7Tv_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BqRNR0BQ.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BGA5OOaq.mjs").then((n) => n.t),
		import("./start-DlPuPGRY.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_KBPUG7Tv_exports as t };
